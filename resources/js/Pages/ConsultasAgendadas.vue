<template>
          ...
          <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div v-if="consultations.length === 0 && !loading">
                ...
                <div v-else>
                  <div v-for="consultation in upcomingConsultations" :key="consultation.id">
                    ...
                    <p>Psicólogo: {{ consultation.psicologo_name }}</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  export default {
    ...
    computed: {
      // Filtrar as consultas que ainda não aconteceram
      upcomingConsultations() {
        ...
        return this.consultations.filter(consultation => {
          ...
          return consultationTime > now && now < consultationEndTime;
        });
      }
    },
    methods: {
